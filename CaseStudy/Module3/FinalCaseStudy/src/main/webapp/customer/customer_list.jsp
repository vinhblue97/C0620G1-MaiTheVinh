        ...
        <table id="example" class="table table-striped table-bordered">
            ...
            <c:forEach var="customer" items="${customerList}">
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${Integer.valueOf(customer.type_of_customer_id)==0}">
                                <c:out value="Diamond"></c:out>
                            </c:when>
                            <c:when test="${Integer.valueOf(customer.type_of_customer_id)==1}">
                                <c:out value="Platinium"></c:out>
                            </c:when>
                            <c:when test="${Integer.valueOf(customer.type_of_customer_id)==2}">
                                <c:out value="Gold"></c:out>
                            </c:when>
                            <c:when test="${Integer.valueOf(customer.type_of_customer_id)==3}">
                                <c:out value="Silver"></c:out>
                            </c:when>
                            <c:when test="${Integer.valueOf(customer.type_of_customer_id)==4}">
