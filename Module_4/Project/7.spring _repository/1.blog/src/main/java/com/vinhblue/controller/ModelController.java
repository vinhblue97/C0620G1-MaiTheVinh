...
import com.vinhblue.model.service.model_management.ModelService;
...
public class ModelController {
    ...
    @GetMapping
    private String home_page(Model model, @RequestParam Optional<String> keyWord, @PageableDefault(size = 5) Pageable pageable) {
        String keyWordOld = "";
        ...
        model.addAttribute("listModel", this.modelService.findAll());
