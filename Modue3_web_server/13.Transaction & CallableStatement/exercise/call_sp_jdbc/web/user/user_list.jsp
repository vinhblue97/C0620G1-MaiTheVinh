...
<table class="table table-striped">
    ...
    <c:forEach var="userList" items="${userList}">
        <tr>
            ...
            <td scope="row">${userList.country}</td>
            <td scope="row"><a href="/user?action=edit&id=${userList.id}"><i class="fas fa-edit"></i></a></td>
            <td scope="row"><a href="/user?action=delete&id=${userList.id}"><i class="fas fa-trash"></i></a></td>
        </tr>
    </c:forEach>
    </tbody>
</table>
